...
class MMoe(nn.Module):
    def __init__(self,
        ...
        # self.experts = nn.ModuleList([CNNExpert(input_channels=1, output_dim=output_dim, kernel_list=[9, 7, 5]),
        #                               CNNExpert(input_channels=1, output_dim=output_dim, kernel_list=[9, 7, 5]),
        #                               CNNExpert(input_channels=1, output_dim=output_dim, kernel_list=[7, 5, 3]),
        #                               CNNExpert(input_channels=1, output_dim=output_dim, kernel_list=[7, 5, 3]),
        #                               CNNExpert(input_channels=1, output_dim=output_dim, kernel_list=[5, 3, 3]),
        #                               CNNExpert(input_channels=1, output_dim=output_dim, kernel_list=[5, 3, 3]),
        #                               CNNExpert(input_channels=1, output_dim=output_dim, kernel_list=[3, 3, 3]),
        #                               CNNExpert(input_channels=1, output_dim=output_dim, kernel_list=[3, 3, 3])
        #                               ])
        
        # self.experts = nn.ModuleList([ResCNNExpert(input_channels=1, output_dim=output_dim)
        #                               for _ in range(num_experts)])
        
        # self.experts = nn.ModuleList([LSTMCNNExpert(input_channels=1, output_dim=output_dim) 
        #                               for _ in range(num_experts)])

        
        # Dilated Convolution Experts
